...
function createJobSeekerCard(jobSeeker) {
    ...
    return `
        <div class="jobseeker-card bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 p-6 animate-fade-in" onclick="openJobSeekerModal(${jobSeeker.id})">
            ...
            <div class="mt-4 pt-4 border-t border-gray-100">
                <button class="w-full text-wow-green hover:text-green-700 font-medium text-sm py-2 hover:bg-green-50 rounded transition-colors">
