...
function createJobCard(job) {
    ...
    return `
        <div class="job-card bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-6 animate-fade-in" onclick="openJobModal(${job.id})">
            ...
            <div class="flex justify-between items-center pt-4 border-t border-gray-100">
                ...
                <button class="text-wow-blue hover:text-blue-700 font-medium text-sm">
